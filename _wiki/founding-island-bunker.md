...
<figure class="wiki-inline-image wiki-inline-image--right">
  <img src="/wiki/assets/images/2016-shelter.webp" alt="The extent of the tornado shelter from 2016, with one side fully open and the status lamp included." loading="lazy">
...
<figure class="wiki-inline-image wiki-inline-image--right">
  <img src="/wiki/assets/images/early-fi-bunker.webp" alt="A very early entrance to the FI Bunker" loading="lazy">
  <figcaption>A very early entrance to the FI Bunker</figcaption>
</figure>

The Founding Island Bunker (now abbreviated as FI Bunker) was first proposed on August 9th, 2021 as an expansion to the tornado shelter. Dragonmaster675 was given it as a first assignment for Team Member, with Artur joining in. The airlock was created by Ij and originally had it's own keycard used, before eventually turning to the Masterkey. The airlock consists of one flush 3x3 and one 1-wide 3x3 with a commandblock particle effect in between, this still exists in the present day bunker. 

<figure class="wiki-inline-image wiki-inline-image--left">
  <img src="/wiki/assets/images/fi-bunker-1-interior.webp" alt="The first FI Bunker interior." loading="lazy">
...
<figure class="wiki-inline-image wiki-inline-image--right">
  <img src="/wiki/assets/images/fi-bunker-catalyst.webp" alt="The FI Bunker around the time of RW&#x27;s 10 Year Anniversary, with several sections of the Blue Zone under construction" loading="lazy">
...
#### Blue Zone {#blue-zone}
The Blue Zone of the FI Bunker contains most of the core areas of the bunker that are necessary for its function. The Blue Zone contains the following rooms:

##### Admin Room {#admin-room}
The Blue Zone (main) Admin Room controls all core functions within the FI Bunker from individual doors to a full reactor shutdown.

###### <small><strong>Primary Section</strong></small> {#primary-section}
The Primary section of the FI Bunker Admin Room can control bunker and founding island lock-downs as well as activate the emergency evacuation sequence. The Primary Section is accessible by a Founding Island level 1 staff key-card.

###### <strong><small>Secondary Section</small></strong> {#secondary-section}
...
The Green Zone of the FI Bunker is where the main transportation hub and food production of the is located.

##### Admin Room/Maintenance Hatch {#admin-room-maintenance-hatch}

##### Keycard Center {#keycard-center}

##### Storage/Farms {#storage-farms}

##### Transit Center {#transit-center}

##### RCorp Rail Admin Station {#rcorp-rail-admin-station}
